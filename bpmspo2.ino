...
//#include <BlynkTimer.h> // Include the BlynkTimer library

MAX30105 particleSensor;
BlynkTimer timer; // Define the BlynkTimer object
...
void setup()
{
  ...
  timer.setInterval(10L, sendSensorData); // Send sensor data every 1 second
}
